    ...
    <div class="container-fluid py-5 px-4">
      ...
      <header class="text-center mb-5 header-section">
        ...
        <p class="text-muted fs-5">
          ระบบจัดการทรัพยากรห้องสมุดอัจฉริยะ
        </p>
      ...
      <!-- ACTION BAR -->
      <div
        class="action-bar d-flex justify-content-between align-items-center mb-4"
      >
            ...
            >
              ...
              <div>
                ...
                >
                  ...
                  <h5 class="card-title fw-bold text-dark text-truncate-2">
                    {{ book.title }}
                  </h5>
      ...
      <Teleport to="body">
        ...
        <div
          v-if="showModal || showModalDetail"
          class="custom-backdrop fade-in"
        ></div>

        <!-- ADD MODAL -->
        <div
          v-if="showModal"
          class="custom-modal-wrapper fade-in"
        >
...
const confirmUpdate = async () => {
  ...
  try {
    ...
    await axios.put(
      `http://localhost:3000/api/books/${showDetail.value.id}`,
      showDetail.value
    )
